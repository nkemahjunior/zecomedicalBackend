...
@Entity
@Table(name = "lab_microbiology")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class LabMicrobiology {
    ...
    @ManyToOne
    @JoinColumn(name = "consultation_id",referencedColumnName = "lab_results_microbiology")
    private Consultation labResultsMicrobiology;
