...
@Entity
@Table(name = "lab_blood_bank")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class LabBloodBank {
    ...
    @ManyToOne
    @JoinColumn(name = "consultation_id",referencedColumnName = "lab_results_blood_bank")
    private Consultation labResultsBloodBank;
